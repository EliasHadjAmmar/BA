...
Having discussed issues with internal validity now, I will briefly talk about external validity. The hypothesis I test is a prediction of the theory of conflict-driven evolution. While the theory itself can be applied widely --- \cite{levine2021} use it to explain stylised facts about pre-modern Europe, pre-modern India, the present-day United Kingdom and Spain, and 20th-century China --- my empirical results only test whether the theory can explain what happens in my dataset. 
