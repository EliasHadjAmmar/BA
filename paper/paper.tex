...
From these sources I assemble a panel of cities. The unique unit of observation is the city-period. The ultimate dataset contains, in abstract terms, two types of variables: ones that code the \textit{territorial history} of cities, and ones that code the occurrence of certain \textit{events}. Records for each city begin in the 14th century at the earliest and end at the latest with the abolition of the German monarchy in the early 20th century. 
...
Problems with construction -> To get more info out of it: Different types of construction
