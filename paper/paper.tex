...
I aggregate data from these sources to obtain a panel of 
...
\begin{figure}[ht]
    ...
    \caption{Share of observations remaining from each \textit{Städtebuch} region when controlling for conflict incidents in Equation \eqref{eq:baseline}. Geo-referenced borders of the regions were not available; this makeshift visualisation shows convex hulls of the city locations in each region (which results in some overlap.)}
