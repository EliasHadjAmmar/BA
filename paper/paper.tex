...
Having discussed issues with internal validity now, I will briefly talk about external validity. For this purpose it is helpful to first put the goal of my paper into context. 
\cite{cantoni2021}

I doubt that we can learn anything about present conflicts or present growth rates from my results. 


In terms of \cite{levine2021, levine2022}'s model of state systems, most international conflict nowadays is defined by the presence of multiple extremely strong outsiders who act to keep the balance of power in the status quo.
