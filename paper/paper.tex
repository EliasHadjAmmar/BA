...
Table \ref{tab:SW22_replication_50y} shows estimates for Equation \eqref{eq:sw22}. Figure \ref{fig:SW_replication} plots the coefficients in column (1) to visualise how the effect evolves dynamically.
