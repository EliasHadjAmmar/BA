...
Because the \textit{Städtebuch} data compiled by \cite{pt2} records exactly how each city was acquired by the territory holding it, I am able to estimate differential trends after different types of ownership changes.\footnote
{
