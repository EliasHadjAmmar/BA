...
Update: It did. Running the code in this file on the newly generated output files returns all the right results (so the comments don't make sense anymore). Bug fixed. Yay!
